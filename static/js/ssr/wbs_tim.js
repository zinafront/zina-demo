...
var wbs_handler = {
    ...
    select_handler: function() {
        var _this = this;
         ...
         $("body").on("change keyup", ".model-site", function() {
             ...
             _this.model_site_notification(zi_partner_handler.get_value(), $(this));
        });
    ...
    zi_partner_change_notification: function() {
        ...
        // if (zi_partner_value != "") {
        $.each($('.model-site'), function(){
            _this.model_site_notification(zi_partner_value, $(this));
        });
        // }
    },

    model_site_notification: function (zi_partner_value, $model_site) {
        ...
        if(zi_partner_value != '') {
            this.load_add_form(prefix, proposal_material_id);
        }
    },
