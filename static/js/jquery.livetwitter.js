 ...
 *
 * WARNING Sadly, Twitter has decided we can't have nice things.
 * The v1.0 API is being retired, and this plugin will cease to function March 2013.
            ...
            if (twitter.settings.refresh || initialize) {
              ...
              $.getJSON(twitter.apiURL(), function (json) {
                ...
                $(results).reverse().each(function () {
                  ...
                  if(twitter.settings.username == false || this.from_user == twitter.settings.username ){
